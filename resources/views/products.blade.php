...
<html lang="en" class="no-js">
   ...
   <body>
      ...
      <!-- End Navbar -->
      <!-- Times -->
      <div class="container-fluid pb-5 times">
         <div class="row">
            <div class="col-md-8 offset-md-1 col-sm-12">
               <h2>Donec rutrum congue leo eget malesuada lacinia eget consectetur sed, convallis at tellus in ipsum id orci porta dapibus.
               </h2>
            </div>
         </div>
         <div class="row">
                  ...
                  <div class="card card-hover h-100">
                     <div class="card-body">
                        <a href="index.html">
                           ...
                           <div class="reveal h-100 bg-black text-white bg-dark text-white p-2 d-flex ">
                              <div class="w-100 align-self-center">
                                 <p class="text-center">I'm vertically centered</p>
                              </div>
                           </div>
                        </a>
                     </div>
